...
import SingleChat from "../cards/UserCard";
...
const CreateContact = () => {
    ...
    return (
        <div className={`h-screen flex flex-col text-white absolute top-0 left-0 w-full transition-all ease-linear  duration-300 delay-150 ${createContact === true ? "-translate-x-0  z-20" : "-translate-x-full"}`}>
            <div className="flex bg-nav-bg items-center gap-4 w-full p-5 h-20 sm:cursor-pointer" onClick={hanldeDiscardChanges}>
            ...
            <section onClick={createGroup} className="cursor-pointer  mt-auto bg-nav-bg hover:bg-[#313d46] w-full grid grid-cols-5 p-3  gap-3">
